...
export default function DayColumn({ day, date, bookings }) {
          ...
          bookings.map((b) => (
            ...
            >
              ...
              <p className="text-sm text-gray-700">
                {new Date(b.scheduleStartTime).toLocaleTimeString("sv-SE", {
                  hour: "2-digit",
                  minute: "2-digit",
                  timeZone: "Europe/Stockholm",
                })}{" "}
                —{" "}
                {new Date(b.scheduleEndTime).toLocaleTimeString("sv-SE", {
                  hour: "2-digit",
                  minute: "2-digit",
                  timeZone: "Europe/Stockholm",
                })}
